...
func init(){
    ...
    image.RegisterFormat(png,"x89x50x4Ex47x0Dx0Ax1Ax0A",png.Decode,png.DecodeConfig)
    image.RegisterFormat(gif, "x47x49x46x38x39x61", gif.Decode, gif.DecodeConfig)
    image.RegisterFormat(bmp, "x42x4D", bmp.Decode, bmp.DecodeConfig)
    }
